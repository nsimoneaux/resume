...
\section{Experience}
\cventry{2020--Present}{Teacher}{Riverdale High School}{Jefferson, LA}{}{
	\vspace*{0.1ex}
Delivering college, career, and technology instruction to high school students. Concurrent completion of the TNTP teacher certification program (High School Mathematics).
\begin{itemize}
\vspace*{1ex}
\item Preparing 12th grades students for the ACT WorkKeys and ACT Tests.
\item Successful implementation of hybrid (remote and in-person) instruction during COVID-19 pandemic.
\item Founding and sponsoring the Riverdale Extracurricular Computer Club.
\end{itemize}}
\vspace*{0.4ex}
...
\begin{itemize}
\vspace*{1ex}
\item Taught CMIN 203 (Logic and Design) and CMIN 216 (Web Foundations I) during the Summer 2020 term.
